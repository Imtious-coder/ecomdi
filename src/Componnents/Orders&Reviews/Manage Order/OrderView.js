    ...
    return (
        <div className='flex grid md:grid-cols-5 grid-cols-1 mt-8'>
            ...
            <main className='w-full col-span-4 bg-gray-100'>
                ...
                <div className=" p-4  flex  md:flex-row ">
                    <div className="md:p-2 md:flex-row flex-col ">
                    ...
                    <table class="w-full flex flex-row flex-no-wrap sm:bg-white rounded-lg overflow-hidden sm:shadow-lg my-5">
                        <thead class="text-black">
                            <tr class="bg-teal-400 flex flex-col flex-no wrap sm:table-row rounded-l-lg sm:rounded-none mb-2 sm:mb-0">
                                <th className="w-1/10 border p-1 ">Document</th>
                                <th className="w-1/10 border p-1">Order no</th>
                                <th className="w-1/10 border p-1">Order date</th>
                                <th className="w-1/10 border p-1">Update date</th>
                                <th className="w-1/10 border p-1">Payment Method</th>
                                <th className="w-1/10 border p-1">Retail Price</th>
                                <th className="w-1/10 border p-1"></th>
                                <th className="w-1/10 border p-1">Status</th>
                                <th className="w-1/10 border p-1">Printed</th>                                <th className="w-1/13 border p-1">Payout Amount</th>
                                <th className="w-1/10 border p-1">Action</th>
