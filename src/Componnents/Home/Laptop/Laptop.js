...
import { faBoxOpen, faCartPlus, faShoppingCart, faStar } from '@fortawesome/free-solid-svg-icons'
...
const Laptop = () => {
    return (
        ...
        <section className="">
            {/* Heading */}
            <p className="Laptop_Heading">Laptop</p>
                ...
                <div className="grid grid-cols-3 gap-1 mt-3 mb-3 ml-3">
                    ...
                    <div className=" border-2">
                        ...
                        <div className="grid grid-cols-3">
                            <div className="text-xs" style={{backgroundColor:""}}>
                                <p>$405</p>
                            </div>
                            <div className="text-xs text-center" style={{backgroundColor:"#ff4747", borderRadius:"10px", paddingBottom:"-10px", margin:"0px"}}>
                                <p>-30%</p>
                            </div>
                            <div className="text-center">
                                <FontAwesomeIcon style={{ fontSize: "20px", color: "#ff4747", }} icon={faCartPlus} />
                            </div>
