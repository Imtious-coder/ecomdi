...
import HCdata from './HCdata.json'
...
const Homeaccess = () => {
    const [accecories, setAccecories] = useState([]);
    useEffect(() => {
        setAccecories(HCdata);
    }, [])
    return (
        <section className="flex ml-10 mr-10">
           <div className="text-center">
            ...
            <div className="ml-5 mb-5">
             <p className="grid font-bold text-2xl ml-5 test mt-5">Home Accecories</p>
