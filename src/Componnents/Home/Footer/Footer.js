    ...
    return (
        <section className="grid md:grid-cols-4 grid-cols-2 bg-gray-900 Font2">
            ...
            <div className="text-white text-sm m-10 leading-6 text-gray-300">
                ...
                <a href=""><p>Become a Delivery Driver</p></a>
                <a href=""><p>Start a package delivery business</p></a>
                <a href=""><p>Advertise Your Products</p></a>
                <a href=""><p>Self-Publish with Us</p></a>
            ...
            <div className="text-white text-sm m-10 leading-5 text-gray-300">
                ...
                <a href=""><p>ecomdi Secured Card</p></a>
                <a href=""><p>ecomdi Business Card</p></a>
                <a href=""><p>ecomdi Business Line of Credit</p></a>
                <a href=""><p>Shop with Points</p></a>
            ...
            <div className="text-white text-sm m-10 leading-5 text-gray-300">
                ...
                <a href=""><p>Returns & Replacements</p></a>
