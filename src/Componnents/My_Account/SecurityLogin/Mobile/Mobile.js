            ...
            <section className="flex justify-center ml-10 mr-10 mt-10 ">
                <div className="md:w-2/5">
                    <div className="border-t-2 border-b-2 mb-5 pt-2 pb-2">
                        <p><b>Old mobile phone number:</b> <br /> <span>BD +880163*****10</span></p>
                    </div>
                    ...
                    <div className="border-t-2 border-b-2 mb-8 mt-3 pt-2 pb-2">
                        <p>By enrolling a mobile phone number, you consent to receive automated text messages from or on behalf of Amazon related to account management and security. Remove your number in Login and Security to cancel. Message and data rates may apply.</p>
                    </div>
                    <Link
                     to="/mobileOTP">
