            ...
            <section className="flex justify-center ml-10 mr-10 mt-10 ">
                <div className="md:w-2/5 border-b-2 pb-5">
                    <div className="border-t-2 border-b-2 mb-5 pt-3 pb-4">
                        <p>
                            To protect your Amazon account, we recommend taking the following steps immediately.
                        </p>
                    </div>
                    <div className="border-t-2 border-b-2 mb-5 pt-3 pb-3">
                       ...
                       <b> Tip:</b> If your email account password was hacked, your Amazon account might be at risk. If your email was forwarded to another address, your account might be at risk.</p>
                    </div>
                    <div className="border-t-2 border-b-2 mb-5 pt-3 pb-3">
                       ...
                       <b> Tip:</b> If your mobile account or SMS is hacked, your Amazon account might be at risk.</p>
                    </div>
                    <div className="border-t-2 border-b-2 mb-5 pt-3 pb-3">
