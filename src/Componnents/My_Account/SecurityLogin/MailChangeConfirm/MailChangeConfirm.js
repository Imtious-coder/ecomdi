        ...
        <section>
            ...
            <section className="flex justify-center ml-10 mr-10 mt-10 ">
                <div className="md:w-2/5">
                    <p className="border-t-2 border-b-2 pt-2 pb-2"><span className="font-bold">Previous email address:</span> <br />
                Yusuf.Islam@gmail.com <br /><p className="font-bold mt-5 -mb-6">Current email address:</p><br /> example@gmail.com</p>
